...
export default function Home() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center p-4 overflow-hidden" ref={containerRef}>
      ...
      <footer className="z-10 mt-10 text-white text-sm font-medium flex items-center justify-center gap-3">
        ❄️ Fun guaranteed
        <a 
          href="https://github.com/sim0wastaken/should-i-go-skiing" 
          target="_blank" 
